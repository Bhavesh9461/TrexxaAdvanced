          ...
          <Link href="/" className="flex min-w-0 items-center gap-3">
            <span className="relative mr-2 flex h-10 w-10 shrink-0 items-center justify-center overflow-visible">
              <Image
                ...
                width={72}
                height={72}
                className="mt-1 mr-3 max-h-none max-w-none origin-left scale-[1.55] object-cover"
                priority
              />
            </span>

            <p className="text-3xl font-mono text-primary uppercase font-semibold tracking-wide sm:text-[2.15rem] bg-clip-text text-transparent bg-gradient-to-r from-[#feac37] to-[#024495] ">
              Trexxa
            </p>
          </Link>
