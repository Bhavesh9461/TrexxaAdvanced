...
export function HomeHeroSection() {
  return (
    <section className="home-hero">
      ...
      <img
        src="https://ik.imagekit.io/bhaveshkumar/brandon-siu-nI7knd5sQfo-unsplash.jpg"
        alt="hero"
          ...
          <Link href="/" className="home-brand">
            <span className="relative mr-2 flex h-10 w-10 shrink-0 items-center justify-center overflow-visible">
              <Image
                ...
                width={72}
                height={72}
                className="w-15 max-h-none max-w-none rounded-3xl origin-left scale-[1.55] object-cover"
                priority
              />
            </span>
