...
export const HERO_VIDEO_SRC = "https://ik.imagekit.io/bhaveshkumar/hero2.mp4";
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  ...
  },
  {
    ...
    body: "Trexxa restyles the image while protecting composition, identity cues, and the small details that matter.",
    icon: SparklesIcon,
    featured: true,
  },
];